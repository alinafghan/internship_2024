...
/**
 * SectionTwo component for text formatting options in the editor.
 * @param {Object} props - The props for the SectionTwo component.
 * @param {Editor} props.editor - The Tiptap editor instance.
 * @returns {JSX.Element}
 */
export default function SectionTwo({ editor }) {
  return (
    <>
      {/* BOLD */}
      <ToolbarButton
